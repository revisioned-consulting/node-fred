...
describe('Builder', () => {
  ...
  describe('setRealTimeStart()', () => {
    ...
    it('should throw an exception since the date was not formatted correctly', () => {
      expect(() => {
        builder.setRealTimeStart({ realtime_start: '10-14-2000' })
      }).to.throw(Error)
    })
  })
  ...
  describe('setRealTimeEnd()', () => {
    ...
    it('should throw an exception since the date was not formatted correctly', () => {
      expect(() => {
        builder.setRealTimeEnd({ realtime_end: '10-14-2000' })
      }).to.throw(Error)
    })
  })
  ...
  describe('setSortOrder()', () => {
    ...
    it('should throw an exception since the sort order was not either asc or desc', () => {
      expect(() => {
        builder.setSortOrder({ sort_order: 'default' })
      }).to.throw(Error)
    })
  })
