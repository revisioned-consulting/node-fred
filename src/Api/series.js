  ...
  getRelatedTagsForSeriesSearch(seriesSearchText, params = {}) {
    return new Promise((resolve, reject) => {
      try {
        ...
        api
          .get(`series/search/related_tags?${url}`)
          .then((res) => {
            resolve(res.data)
          })
          .catch((err) => {
